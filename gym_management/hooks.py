...
app_publisher = "Shridevi Shrishail Madiwalar"
app_description = "The Gym Management System (GMS) is a comprehensive application designed to manage memberships, workout plans, locker allocation, professional trainer subscriptions, and group classes for a local gym."
app_email = "shridevi.madiwalar@promantia.com"
app_license = "mit"
